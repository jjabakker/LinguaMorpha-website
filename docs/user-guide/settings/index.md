...
See the [Getting Started guide](../../documentation/getting-started.md#2-set-up-speech-one-time-strongly-recommended) for step-by-step instructions on downloading the Enhanced or Premium voices.
...
All study data lives on your device only. See the [Privacy Policy](../../privacy-policy.md) for the full picture.
