...
- **Topic** — limit to one or more categories such as greetings, food, travel, time, …

Tap **Matching phrases** to browse the full list before confirming the selection.
...
- Your **phrase pool** is the set of phrases eligible to appear in any session — the result of your filters.
- Your **session size** (set in [Settings → Sessions](../../settings/#sessions)) is how many of those phrases appear in a single sitting (10, 20, 30, 50, or All).

Each session, the app picks the best N phrases from your pool, prioritising unseen and weak ones.
