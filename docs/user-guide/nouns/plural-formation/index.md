...
Use [Singular / Plural](../singular-plural/) to drill the rule. The deck includes a mix of regular cases (vowel → -s, consonant → -es) and the trickier *z → ces* and accent-shift cases, so you cover the full range rather than only the easy patterns.
