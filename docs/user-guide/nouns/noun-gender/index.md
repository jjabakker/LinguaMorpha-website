...
- **la radio** — *the radio* (ends in -o, but feminine in most regions)
- **el día** — *the day* (ends in -a, but masculine)
- **el mapa** — *the map* (ends in -a, but masculine)
- **el agua** — *the water* (feminine, but takes *el* in the singular for sound reasons; plural is *las aguas*, adjectives are still feminine)
