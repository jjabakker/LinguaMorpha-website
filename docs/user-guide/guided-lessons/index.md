...
- If the lesson includes nouns or expressions, a **Vocabulary** screen lists those too.

**Phase 2 — Practice.** Once you feel ready, work through the exercises. Depending on the lesson, these may include verb meaning flashcards, conjugation drills, noun flashcards, and expression flashcards.

An **Include previous** toggle lets you broaden the practice pool to include all verbs and vocabulary introduced in earlier lessons, not just the current one — useful for keeping older material fresh.
...
…then [Self Study](../self-study/) gives you the controls. Many learners switch between the two modes depending on the week.
